...
namespace Opm {
    ...
    namespace Detail {
        ...
        ///
        /// At namespace scope, not nested: MSVC does not treat a nested class
        /// as complete when it is the element type of a std::array member of
        /// the enclosing class template (C2079).
        template <typename Scalar>
