                    ...
                    DeferredLogger& deferred_logger) const
{
    ...
    if (this->isOperableAndSolvable()) {
        ...
        // Per-connection (CECON) economic limits are checked independently
        // of the well-level (WECON) check because they may apply to wells
        // that are operable but have individual connections that violate
        // their own limits.
        WellTest(*this).updateWellTestStateConnectionEconomic(ws, simulationTime, writeMessageToOPMLog,
