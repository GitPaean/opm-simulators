...
recoverSolutionWell(const BVector& x, BVectorWell& xw) const
{
    ...
    /* if (baseif_.name() == "PR02_G12") {
        ...
        const std::string matrix_filename = "debug_output/duneD_PR02_G12_rev_" + std::to_string(number);
        const std::string rhs_filename = "debug_output/resWell_PR02_G12_rev_" + std::to_string(number);
        std::cout << " at recoverSolutionWell outputting the Matrix duneD_ and resWell for well PR02_G12 to file " << matrix_filename
        ...
        const std::string xw_filename = "debug_output/xw_PR02_G12_rev_" + std::to_string(number);
...
{
    const bool output_for_well = (baseif_.name() == "PR02_G12");
    if (output_for_well) {
