     ...
     const bool enableDistributedWells)
{
...

    {
        ...
        if (index.has_value()) {
            ...
            const std::string msg1 = "WellState init for well " + well_name + " before copying :\n";
    ...
    }
    {
        ...
        if (index.has_value()) {
            const auto& ws = this->wells_[well_name];
            const std::string msg1 = "WellState init for well " + well_name + " after checking previousState :\n";
            const std::string msg = ws.briefDebugInfo();
            OpmLog::debug(msg1+msg);
        }
    }
