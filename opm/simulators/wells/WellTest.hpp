...
private:
    ...
    //! \brief Check the minimum production rate limits (WECON items 2, 3, 14
    //!        and 16) against \p rates_or_potentials, which holds the well's
    //!        surface rates or, when WECON item 10 is POTN, its surface
