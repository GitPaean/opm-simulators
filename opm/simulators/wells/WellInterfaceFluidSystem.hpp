...
{
  template <typename Scalar, typename IndexTraits, typename Region> class SurfaceToReservoirVoidage;
}
...
protected:
    ...
    SurfaceToReservoirVoidage<typename FluidSystem::Scalar, typename FluidSystem::IndexTraitsType, std::vector<int>>;
