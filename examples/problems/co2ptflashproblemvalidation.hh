 ...
 */
#ifndef OPM_CO2PTFLASH_PROBLEM_VALIDATION_HH
#define OPM_CO2PTFLASH_PROBLEM_VALIDATION_HH
...
struct EpisodeLength { static constexpr Scalar value = 5 * 21600.0; };
...
public:
    ...
    static void registerParameters()
    {
        ...
        Parameters::SetDefault<Parameters::CellsX>(1000);
        Parameters::SetDefault<Parameters::DomainSizeX<Scalar>>(1000.);
        ...
        Parameters::SetDefault<Parameters::EndTime<Scalar>>(1.296e8 / 2.);
        Parameters::SetDefault<Parameters::InitialTimeStepSize<Scalar>>(21600.0);
